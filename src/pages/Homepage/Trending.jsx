  ...
  return (
    <div>
      <div className="navigation flex items-center justify-between p-[10px] l:p-[5px]">
        <h3 className='text-black-lighter ml-[18px] l:ml-[10px] l:text-[22px] mid-sm:text-[20px] mid-sm:ml-[5px] text-[25px] font-[800]'>Trending</h3>
